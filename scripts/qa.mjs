...
try {
  ...
  await interactionPage.getByRole('navigation', { name: 'أقسام القائمة' }).getByRole('link', { name: 'المقبلات' }).click()
  check(new URL(interactionPage.url()).hash === '#starters', 'تنقل أقسام القائمة لا يحدّث الرابط')
